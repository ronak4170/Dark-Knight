...
const PORTRAITS = {
	"Player": preload("res://dialogue/Samurai_1/Talk.png"),
	"PlayerRage": preload("res://dialogue/Samurai_1/Aggression.png"),
	"Ghost": preload("res://dialogue/Samurai_1/Calm.png"),
	"EnemySmile": preload("res://dialogue/Samurai_3/Smile.png"),
	"EnemySpecial": preload("res://dialogue/Samurai_3/Calm.png"),
}
...
func _ready() -> void:
	...
	dialogue_label.add_theme_font_size_override("normal_font_size", 45)
	character_label.add_theme_font_size_override("normal_font_size", 50)
...
func apply_dialogue_line() -> void:
	...
	var display_name = DISPLAY_NAMES.get(character_name, character_name)
	character_label.text = "[b][u]" + display_name + "[/u][/b]"
